...
public class AhoCorasickGFG {
    ...
    // Builds the String matching machine. arr - array of words. The index of each keyword is important: "out[state] & (1 << i)" is > 0 if we just found word[i] in the text.
    // Returns the number of states that the built machine has. States are numbered 0 up to the return value - 1, inclusive.
